...
Hummingbird's network filter and lock natively uses `iptables`, `nftables` and
`pf` in order to provide a "best effort leak prevention". Hummingbird will
automatically detect and use the infrastructure available on your system.
